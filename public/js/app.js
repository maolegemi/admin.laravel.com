requirejs.config({
    ...
    paths: {
        ...
        datetimepicker_cn:'plugin/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN',
        ...
        flot_resize: 'plugin/flot/jquery.flot.resize.min',
        app: 'page',
    },
    map: {
        '*': {
    ...
    shim: {
        ...
        datetimepicker: { deps: ['bootstrap', 'css!plugin/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css'] },
        datetimepicker_cn:{deps:['datetimepicker']},
        datepicker: { deps: ['bootstrap','css!plugin/datepicker/datepicker3.css'] },
