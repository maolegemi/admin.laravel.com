    ...
    return {
        init: function() {
                ...
                consumeObj = {
                    consumeTable: '',
                    search: function() {
                        this.consumeTable.draw();
                    },
                    reset: function() {
                        $("#consume-form")[0].reset();
                        var shopObj = $('#shop');
                    ...
                    barInit: function() {
                        ...
                        consumeObj.pointChange(pointObj);
                    },
                    ...
                    tableInit: function() {
                        this.consumeTable = $('#consumeTable').DataTable({
                            responsive: true,
                            serverSide: true,
                            processing: false,
                            bSort: true,
                            ...
                            ajax: {
                                url: "",
                                data: function(d) {
                                    $.each($("#consume-form").serializeArray(), function(k, v) {
                                        d[v['name']] = v['value'];
                                    });
                                }
                            },
