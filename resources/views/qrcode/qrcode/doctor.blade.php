    ...
    <section class="content">   
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">医生扫码统计</h3>
        </div>
        <div class="box-body">
         <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" id="doctor-nav">
            ...
            <form id="monthly-form" action="" method="get">
              ...
              <input data='monthpicker' class="form-control pull-right" name="date" value="{{date('Y-m-d',strtotime('-4 month'))}}" type="text">
              </div>
              </div>
              </div>
              <div class="col-md-2">
